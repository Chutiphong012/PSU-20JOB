...
export default function AdminLogin() {
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
        <h2 className="text-2xl font-semibold text-[#18305D] text-center mb-4">เข้าสู่ระบบผู้ดูแลระบบ</h2>
        ...
        <button className="w-full bg-[#001C54] hover:bg-[#001235] text-white py-3.5 px-4 rounded-xl flex items-center justify-center gap-3 transition-all shadow-md">
            <span className="font-semibold tracking-wide">PSU PASSPORT</span>
        </button>
        ...
        <div className="relative py-2">
            ...
            <div className="relative flex justify-center text-xs">
                <span className="px-4 bg-white text-gray-400">หรือ เข้าสู่ระบบด้วยอีเมล</span>
            </div>
        </div>
